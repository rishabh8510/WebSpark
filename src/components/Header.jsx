...
const iconMap = {
  ...
  "Computer Vision": FaEye,
  "NLP Solutions": FaCommentDots,
  "Risk Scoring Systems": FaShieldAlt,
  "Chatbots & Virtual Assistants": FaRobot,
  "Sentiment Analysis": FaSmile,
  "Email Automation": FaEnvelopeOpenText,
  "Facial Recognition": FaCamera,
  "AR Filters": FaCameraRetro,
  "Creative AI Apps": FaPaintBrush,
  "Robotic Process Automation (RPA)": FaRobot,
  "AI-Powered CRMs": FaAddressBook,
  "Smart Assistants": FaHeadset,
  "TensorFlow Models": FaCogs,
  "Reinforcement Learning": FaTrophy,
  "AI for E-commerce Personalization": FaShoppingCart,
  "AI in Telecom Operations": FaNetworkWired,
  "Intrusion Detection AI": FaLock,
  "AI for CCTV Monitoring": FaVideo,
  "Revenue Forecasting AI": FaDollarSign,
  "Customer Support": FaHeadset,
  "Back Office": FaBuilding,
  "Data Entry": FaDatabase,
  "Email Support Services": FaEnvelope,
  "Technical Support": FaWrench,
  "Customer Onboarding": FaUserCheck,
  "Data Management": FaFileAlt,
  "Document Digitization": FaFilePdf,
  "Quality Assurance (QA)": FaCheckCircle,
  "Inventory Management": FaBoxes,
  "Knowledge Base Management": FaBook,
  "IT Helpdesk Support": FaLaptop,
  "Recruitment Process Outsourcing (RPO)": FaUserFriends,
  "Real Estate BPO Support": FaHome,
  "Order Fulfillment": FaTruckMoving,
  "SOP Documentation": FaClipboardList,
  "Internal Communication Management": FaComments,
  "Project Documentation Support": FaFileSignature,
  "Process Reengineering": FaRedo,
  "E-learning BPO": FaChalkboardTeacher,
  "Inventory Syncing": FaSyncAlt,
  "Case Studies": FaClipboard,
  "Client Success": FaThumbsUp,
  "Portfolio": FaCube,
  "Product Demos": FaLaptopHouse,
  "UI/UX Showcases": FaMapMarkerAlt,
  "Performance Benchmarks": FaStarHalfAlt,
  "Revenue Growth Stats": FaRocket,
  "Automation Impact": FaSatellite,
  "Speed Optimization Results": FaSlidersH,
  "User Retention Results": FaBell,
  "Client Testimonials": FaUsers,
  "Video Testimonials": FaMicrophone,
  "Written Feedback": FaClipboard,
  "Google Reviews": FaRegStar,
  "Partner Endorsements": FaCrown,
  "B2B Tools": FaDraftingCompass,
  "B2C Platforms": FaUsers,
  "Real Estate Platforms": FaMapPin,
  "Logistics Tech": FaBed,
  "SaaS Deployments": FaServer,                                          
  "AI & ML Model Deployments": FaLightbulb,
  "IoT Integrations": FaCube,
  "API Integrations": FaRocket,
  "CRM Customizations": FaBriefcase,
  "Web App Rollouts": FaSlidersH,
  "Brochures": FaMapPin,
  "Community Contributions": FaCompass
};
